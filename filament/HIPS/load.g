...
;
M291 P"Please wait while the nozzle is being heated up" R"Heating: 220°C" S1 T5; display message
;
T0                                                                     ; select tool 0
G91                                                                    ; relative positioning
G1 Z20 F6000 H2                                                        ; lift z relative to current position
M568 P0 S220 A2                                                        ; set current tool temperature to filament 220°C
